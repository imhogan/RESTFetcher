...
SET __APPLICATION_NAME=Installing THINKronicity files for ReSTFetcher Survey Monkey Sample
SET _OPEN_AWS_REGION_MASTER=ap-northeast-1:apne1 
SET _OPEN_AWS_REGIONS_REPLICA=us-east-1:usea1 us-west-2:uswe2 eu-west-1:euwe1
...
DEL "%_INSTALL_PATH%S3Buckets\opencode\au-com-thinkronicity-RestFetcher-SurveyMonkeySample-V%_VERSION%.zip"

7za a -r -tZIP "%_INSTALL_PATH%S3Buckets\opencode\au-com-thinkronicity-RestFetcher-SurveyMonkeySample-V%_VERSION%.zip" *.*
