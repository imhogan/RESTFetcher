...
SET __APPLICATION_NAME=Installing files for ReSTFetcher EmailMonitor Sample
...
DEL "%_INSTALL_PATH%S3Buckets\opencode\au-com-thinkronicity-RestFetcher-%_SampleName%Sample%_SampleID%-V%_VERSION%.zip"

%_7ZIP% a -r -tZIP "%_INSTALL_PATH%S3Buckets\opencode\au-com-thinkronicity-RestFetcher-%_SampleName%Sample%_SampleID%-V%_VERSION%.zip" *.*
